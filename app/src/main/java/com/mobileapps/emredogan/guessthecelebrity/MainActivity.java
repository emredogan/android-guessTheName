package com.mobileapps.emredogan.guessthecelebrity;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void celebChosen(View view) {
        ...
        if(view.getTag().toString().equals(Integer.toString(locationOfCorrectAnswer))) {
            ...
            Toast.makeText(this, "Wrong it was:" + celebNames.get(chosenCelebrity), Toast.LENGTH_SHORT).show();
        }
    ...
    public void newQuestion() {
        ...
        try {
            ...
            chosenCelebrity = rand.nextInt(celebURLs.size());
